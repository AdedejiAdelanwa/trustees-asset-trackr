...
const Login = () => {
    ...
    const validate = (e) => {
        const Val = validator.isStrongPassword(e, {minLength: 8, minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1})
        ...
        <main className="flex font-Poppins">
            ...
            <div className="w-1/2 md:h-fit sm:w-full md:mx-[1rem] sm:mx-[2rem] bg-white mt-[12.5rem] sm:mt-[7rem] md:mt-[13.5rem] mt-[6rem] sm:my-[0rem] ml-[12rem] ">
                ...
                <div className="flex flex-col mb-5 mt-[3rem]">
                    ...
                    <input onChange={validateEmail} className="bg-[#F3F3F3] w-[38rem] pt-[1.6rem] pr-[1.2rem] pb-[1.4rem] pl-[1.4rem] mt-[0.4rem]  rounded-[0.5rem]" id="grid-Email-Address" type="email" placeholder="jobori@gmail.com" required
                    />
                    <div className="mt-[1rem] font-bold text-[#FF0000] text-[1.4rem] " >{isEmailValid}</div>
                </div>
