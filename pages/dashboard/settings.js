        ...
        <TabPanels>
          ...
          <TabPanel>
            <Box w={{ base: "100%", lg: "57rem" }} mt="2rem">
              ...
              <Text>
                Enter your bank verification number. If you don’t have it, dial
                *565*0# or contact your bank.
              </Text>
            </Box>
            ...
            <Box mt="2rem" w={{ base: "100%", lg: "52rem" }}>
              ...
              <Text>
                You’ll need to upload a valid means of Identification so we know
                its you. Select from the list and upload the corresponding
                document.
              </Text>
            </Box>
            <VStack alignItems={"flex-start"} mt="2rem">
