              ...
              <TabPanel>
                <div className="relative flex items-center overflow-x-auto space-x-8">
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => (
                    <Link href={'../assets/preview-doc.png'} download target="_blank" key={num}>
                    <div
                    ...
                    >
                      <Image  boxSize={"25rem"} src={"../assets/preview-doc.png"} fallbackSrc='https://via.placeholder.com/150' alt="describe" />
